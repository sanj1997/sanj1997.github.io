...
const Navbar=()=>{
    return (
       <Flex position={"sticky"} top="0px" zIndex={"3"} bg={["#fce5d8","#fce5d8","rgb(44,19,56)"]} p={["2rem"]} alignItems={"center"} justifyContent={"space-between"} h={["40px","40px","60px"]}>
         ...
         <Link activeClass="active" to="stats" spy={true} offset={-50} smooth={true}  duration={700} cursor={'pointer'}><Button _hover={"none"} _active={"none"} bg={"none"}><Text _hover={{color:"#e57cd8"}} color={"#fff3ed"}>STATISTICS</Text></Button></Link>
